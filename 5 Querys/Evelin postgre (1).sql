...
CREATE TABLE DocumentRequest (
    DocumentRequestID Serial PRIMARY KEY,
...
ALTER TABLE Employee
ADD CONSTRAINT FK_Employeecreate FOREIGN KEY (idUserCreate) REFERENCES Use (idUser);
ALTER TABLE Employee
ADD CONSTRAINT FK_Employeemodify FOREIGN KEY (idUserModify) REFERENCES Use (idUser);

--Employeetype
ALTER TABLE Employee
ADD CONSTRAINT FK_Employeetypecreate FOREIGN KEY (idUserCreate) REFERENCES Use (idUser);
ALTER TABLE Employee
ADD CONSTRAINT FK_Employeetypemodify FOREIGN KEY (idUserModify) REFERENCES Use (idUser);
...
ALTER TABLE DocumentRequest
ADD CONSTRAINT FK_DocumentRequestcreate FOREIGN KEY (idUserCreate) REFERENCES Use (idUser);

ALTER TABLE DocumentRequest
ADD CONSTRAINT FK_DocumentRequestmodify FOREIGN KEY (idUserModify) REFERENCES Use (idUser);

--DocumentType
ALTER TABLE DocumentType
ADD CONSTRAINT FK_DocumentTypecreate FOREIGN KEY (idUserCreate) REFERENCES Use (idUser);
ALTER TABLE DocumentType
ADD CONSTRAINT FK_DocumentTypemodify FOREIGN KEY (idUserModify) REFERENCES Use (idUser);

--Career
ALTER TABLE Career
ADD CONSTRAINT FK_Careercreate FOREIGN KEY (idUserCreate) REFERENCES Use (idUser);
ALTER TABLE Career
ADD CONSTRAINT FK_Careermodify FOREIGN KEY (idUserModify) REFERENCES Use (idUser);
